...
def dashboard():
    if'user_id' in session:
        ...
        return render_template('dashboard.html',title="dashboard",modify=modify,filter_date=month_filter,category=category,Transac=transactions,transactform=form,style='./static/dashboard.css',script='./static/dashboard.js')
    else:
