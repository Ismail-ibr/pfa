...
class SignUpForm(FlaskForm):
    ...
    phonenumber = StringField('phone number', validators=[DataRequired()], render_kw={"class": "form-label form-control", "placeholder": "Enter your phonenumber"})
    password = PasswordField('password', validators=[DataRequired()], render_kw={"class": "form-label form-control"})
