...
class SignUpForm(FlaskForm):
    name=StringField('Fullname',validators=[DataRequired()], render_kw={"class": "form-label"})
    email=EmailField('email',validators=[DataRequired(),Email()], render_kw={"class": "form-label"})    
    phonenumber=IntegerField('phone number',validators=[DataRequired()], render_kw={"class": "form-label"})
