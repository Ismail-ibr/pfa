...
class SignUpForm(FlaskForm):
    name=StringField('Fullname',validators=[DataRequired()], render_kw={"class": "form-label","placeholder":"Enter your username"})
    email=EmailField('email',validators=[DataRequired(),Email()], render_kw={"class": "form-label","placeholder":"Enter your email"})    
    phonenumber=IntegerField('phone number',validators=[DataRequired()], render_kw={"class": "form-label","placeholder":"Enter your phonenumber"})
    password=PasswordField('password',validators=[DataRequired()], render_kw={"class": "form-label","placeholder":"&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;"})
